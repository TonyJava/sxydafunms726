...
<script language="JavaScript" type="text/javascript">
  function toAdd()
  {
       mainForm.action = "<%=rootPath%>/ipmac.do?action=update";
       mainForm.submit();
  }
</script>
			...
			<tr>
				...
				<td height=300 bgcolor="#FFFFFF" valign="top"  align="center">				
				  ...
				  <table border="0" id="table1" cellpadding="0" cellspacing="1"
					...
					<TBODY>
						<tr>
							<TD align="left" colspan="4" height="24">IP信息--编辑</TD>
						</tr>
						<tr>
						...
						<tr style="background-color: #ECECEC;">
							...
							<TD nowrap>&nbsp;<%=vo.getMac()%></TD>	
						</tr>
						<tr>	
							<TD nowrap align="right" height="24">用户名&nbsp;</TD>				
							<TD nowrap>
								&nbsp;<input name="person" type="text" size="16" class="formStyle" value="<%=vo.getPerson()%>">
							</TD>						
							<TD nowrap align="right" height="24">部门&nbsp;</TD>				
							<TD nowrap>&nbsp;<input name="dept" type="text" size="16" class="formStyle" value="<%=vo.getDept()%>">														
							</TD>	
						</tr>
						<tr style="background-color: #ECECEC;">
							<TD nowrap align="right" height="24">房间号&nbsp;</TD>				
							<TD nowrap>&nbsp;<input name="room" type="text" size="16" class="formStyle" value="<%=vo.getRoom()%>"></TD>								
							<td align="right" height="20">电话&nbsp;</td>
							<td colspan="3" align="left">&nbsp;<input name="tel" type="text" size="16" class="formStyle" value="<%=vo.getTel()%>"></td>
						</tr>
						<tr>
