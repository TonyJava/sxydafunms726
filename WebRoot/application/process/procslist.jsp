...
<%
  ...
  List list = (List)request.getAttribute("ipList");
		...
		<td align="center" valign=top>
			...
			<tr>
				<td background="<%=rootPath%>/common/images/right_t_02.jpg" width="100%"><table width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td class="layout_title">应用 >> 服务管理 >> 进程监视列表</td>
			...
			%>
   										<tr bgcolor="#FFFFFF" <%=onmouseoverstyle%> height=25>  
												...
												<%if(vo.getWbstatus()==0){%>
												<td  align='center' style="cursor:hand">白名单</td>
												<%}else{%>
												<td  align='center' style="cursor:hand">黑名单</td>
												<%}%>
												<%if(vo.getAlarmLevel()==1){%>
												<td  align='center' style="cursor:hand">普通告警</td>
												<%}else if(vo.getAlarmLevel()==2){%>
												<td  align='center' style="cursor:hand">严重告警</td>
												<%}else if(vo.getAlarmLevel()==3){%>
												<td  align='center' style="cursor:hand">紧急告警</td>
												<%}%>
    											<td  align='center'><%=vo.getBak()%></td> 
												<td height=25>&nbsp;
												<img src="<%=rootPath%>/resource/image/status.gif"
																border="0" width=15 oncontextmenu=showMenu('2','<%=vo.getId()%>','') alt="右键操作">
											</td>
  										</tr>			
								<%} %>
									</table>
