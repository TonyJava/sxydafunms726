...
<!-- 这里用来定义需要显示的右键菜单 -->
	...
	<table border="1" width="100%" height="100%" bgcolor="#F1F1F1"
		...
		<tr>
			<td style="cursor: default; border: outset 1;" align="center"
				onclick="parent.cancelalert()">取消监视</td>
		</tr>
		<tr>
			<td style="cursor: default; border: outset 1;" align="center"
				onclick="parent.addalert()">添加监视</td>
		</tr>		
	</table>
	</div>
	<!-- 右键菜单结束-->
			...
			<tr>
				<td background="<%=rootPath%>/common/images/right_t_02.jpg" width="100%"><table width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td class="layout_title">应用 >> 中间件管理 >> WAS监视列表</td>
...
%>
	...
	<!--	<td height=25>&nbsp;<%=vo.getNodename()%></td>
		<td height=25>&nbsp;<%=vo.getServername()%></td> -->
        <td height=25>&nbsp;<%=vo.getVersion()%></td>
		<td height=25>
			<%
				if(vo.getMon_flag() == 0){
			%>
