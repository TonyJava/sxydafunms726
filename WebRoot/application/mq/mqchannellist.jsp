	...
	<tr>
		...
		<td align="center" valign=top >
			...
			<tr>
				<td background="<%=rootPath%>/common/images/right_t_02.jpg" width="100%"><table width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td class="layout_title">应用 >> 中间件管理 >> MQ通道监视列表</td>
        	...
        	<tr>           
						...
						&nbsp;<input type="submit" value="刷新MQ告警配置" class="button" onclick="createMQConfig(operate,'create_mqconfig')">
          							</td>            
...
%>
       <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%> class="microsoftLook">
		...
		<td height=25>&nbsp;<%=vo.getConnipaddress()%></td>
		<td height=25>
			<%
