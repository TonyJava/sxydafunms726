...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk1 = checkinput("class_name","string","集群名称",50,false);
     var chk2 = checkinput("class_pesc","string","集群描述",50,false);
     
      if(chk1&&chk2)
     {      
            Ext.MessageBox.wait('数据加载中，请稍后.. ');
        	mainForm.action = "<%=rootPath%>/lsfprocess.do?action=add";
        	mainForm.submit();
     }
       // mainForm.submit();
 });	
																	...
																	<td>
																		<table border="0" id="table1" cellpadding="0"
																			...
																			<tr style="background-color: #ECECEC;">
																				...
																				<TD>
																					<input type="text" name="class_name" id="class_name" size="40">
																				</TD>
																			</tr>
																			...
																			<tr style="background-color: #ECECEC;">
																				...
																				<TD>
																					<input type="text" name="class_pesc" id="class_pesc" size="40">
																				</TD>
																			</tr>
																			<tr>
