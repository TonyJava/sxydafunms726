		...
		<table id="body-container" class="body-container">
			<tr>
				...
				<td class="td-container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">自动化 >> 自动化控制 >> CISCO SLA 编辑</td>
					...
					<TBODY>
						<tr>						
							<TD nowrap align="right" height="24" width="10%">&nbsp;</font>IP地址&nbsp;</TD>				
						...
						<tr style="background-color: #ECECEC;">						
							...
							<TD nowrap width="40%">&nbsp;
								<input type="text" name="descr" maxlength="50" size="20" class="formStyle" value="<%=vo.getDescr()%>">
							</TD>
						</tr>
				<tr>						
							...
							<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>采集间隔&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;
