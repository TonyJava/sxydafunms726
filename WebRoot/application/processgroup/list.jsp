		        										...
		        										<td colspan="2">
		        											<table>
		        												<tr>
		        													...
		        													<td align="center" class="body-data-title">进程控制</td>
		        												...
		        												<%
					        									    if(list!=null&& list.size()>0){
					        									        for(int i = 0 ; i < list.size() ; i++){
					        									        	Procs process = (Procs)list.get(i);
					        									        	
					        									        	String alarmlevel = process.getAlarmLevel()+"";
					        									        	String monflag = process.getFlag()+"";
					        									            ...
					        									            %>
					        									            <tr <%=onmouseoverstyle%>>
					        													<td align="center" class="body-data-list"><INPUT type="checkbox" value="<%=process.getId()%>" name="checkbox" id="checkbox"><%=i + 1%></td>
					        													<td align="center" class="body-data-list"><%=process.getIpaddress()%></td>
					        													<td align="center" class="body-data-list"><a href="#" onclick='edit("<%=process.getId()%>")'><%=process.getProcname()%></a></td>
								        										<%if(process.getWbstatus()==0){%>
																					<td align="center" class="body-data-list">白名单</td>
																				<%}else{%>
																					<td align="center" class="body-data-list">黑名单</td>
																				<%}%>
