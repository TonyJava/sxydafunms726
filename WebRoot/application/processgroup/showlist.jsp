		        												...
		        												<%
					        									    if(list!=null&& list.size()>0){
					        									        ...
					        									        for(int i = 0 ; i < list.size() ; i++){
					        									        	Procs processGroup = (Procs)list.get(i);
					        									        	
					        									        	String alarmlevel = processGroup.getAlarmLevel()+"";
					        									        	
					        									        	String monflag = processGroup.getFlag()+"";
					        									            ...
					        									            <tr <%=onmouseoverstyle%>>
					        													...
					        													<td align="center" class="body-data-list"><%=processGroup.getProcname()%></td>
