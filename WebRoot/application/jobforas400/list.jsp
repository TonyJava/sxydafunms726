											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 应用 >> AS400作业组管理 >> 列表 </td>
		        										...
		        										<td colspan="2">
		        											<table>
		        												<tr>
		        													...
		        													<td align="center" class="body-data-title">作业组名称</td>
		        												...
		        												<%
					        									    if(list!=null&& list.size()>0){
					        									        for(int i = 0 ; i < list.size() ; i++){
					        									            ...
					        									            %>
					        									            <tr <%=onmouseoverstyle%>>
					        													<td align="center" class="body-data-list"><INPUT type="checkbox" value="<%=jobForAS400Group.getId()%>" name="checkbox" id="checkbox"><%=i + 1%></td>
					        													<td align="center" class="body-data-list"><%=jobForAS400Group.getIpaddress()%></td>
					        													<td align="center" class="body-data-list"><a href="#" onclick='edit("<%=jobForAS400Group.getId()%>")'><%=jobForAS400Group.getName()%></a></td>
