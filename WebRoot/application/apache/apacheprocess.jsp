														...
														<tr>
															<td width="80%" align="left" class=dashLeft>
																<table style="BORDER-COLLAPSE: collapse"
																	bordercolor=#cedefa cellspacing="0" cellpadding="1"
																	...
																	<tr>
																		...
																		<td align=center><%=apache_ht.get("req_sec")%></td>
																	</tr>
																	<%
																		}
																	%>
																	...
																	<tr>
																		...
																		<td align=center><%=apache_ht.get("b_req")%></td>
																	</tr>
																	<%
																		}
																	%>
																	...
																	<tr>
																		...
																		<td align=center><%=apache_ht.get("b_sec")%></td>
																	</tr>
																	<%
																		}
																	%>
																	...
																	<tr>
																		...
																		<td align=center><%=apache_ht.get("process")%></td>
																	</tr>
																	<%
																		}
																	%>
																	...
																	<tr>
																		...
																		<td align=center><%=apache_ht.get("workers")%></td>
																	</tr>
																	<%
																		}
																	%>
