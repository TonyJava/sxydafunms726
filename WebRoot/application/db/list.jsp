											        		...
											        		<table>
											        			<tr>
																	<td style="text-align: right;" class="body-data-title">
																		<b>展示样式 [<a href="<%=rootPath%>/db.do?action=list&jp=1">
																		<font color="#397DBD">列表</font></a> 
																		<a href="<%=rootPath%>/databaseflex/list.jsp?flag=<%=flag %>"><font color="#397DBD">图形</font></a>]</b>&nbsp;&nbsp;
					        								...
					        								//System.out.println(status+"====");      	
		        									            ...
		        									            <tr <%=onmouseoverstyle%>>
												                    ...
												                    <td align="center" class="body-data-list"><%=monitorDBDTO.getPingValue()%></td>
			       													<td align="center" class="body-data-list">
			       														<img src="<%=rootPath%>/resource/image/status.gif" border="0" width=15 oncontextmenu=showMenu('2','<%=monitorDBDTO.getId()%>','<%=monitorDBDTO.getIpAddress()%>:<%=monitorDBDTO.getSid()%>') alt="右键操作">
			       													</td>
					        									</tr>
