...
function setClass(){
	document.getElementById('sybDetailTitle-5').className='detail-data-title';
	document.getElementById('sybDetailTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('sybDetailTitle-5').onmouseout="this.className='detail-data-title'";
}
