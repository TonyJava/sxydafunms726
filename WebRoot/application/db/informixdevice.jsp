													...
													<tr>
														...
														<script>
															...
															setTimeout(function(){
															  ...
															  mainForm.action = "<%=rootPath%>/informix.do?action=sychronizeData&dbPage=<%=dbPage %>&id=<%=id %>&myip=<%=myip %>&myport=<%=myport %>&myUser=<%=myUser %>&myPassword=<%=myPassword %>&sid=<%=mysid %>&flag=1";
															  mainForm.submit();
															 });    
															});
														</script>
