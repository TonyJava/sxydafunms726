...
<%@page import="com.afunms.application.course.model.LsfClassNode"%>
...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     {      
        	...
        	mainForm.action = "<%=rootPath%>/lsfprocessnode.do?action=update";
        	mainForm.submit();
     }
       // mainForm.submit();
 });	
																...
																<tr>
																	<td>
																		<table border="0" id="table1" cellpadding="0"
																			...
																			<%
																			LsfClassNode vo=(LsfClassNode)request.getAttribute("vo"); 
																			%>
																			...
																			<input type="hidden" name="class_id_old" id="class_id" size="30" value="<%=vo.getClass_id() %>">
																			<input type="hidden" name="nodeid_old" id="class_id" size="30" value="<%=vo.getNodeid() %>">
																			...
																			<tr style="background-color: #ECECEC;">
																				...
																				<TD>
																					<input type="text" name="nodeid" id="nodeid" size="30" value="<%=vo.getNodeid() %>">
																				</TD>
																			</tr>
																				...
																				<TD nowrap align="right" height="24">是否采集&nbsp;</TD>				
																            		<TD nowrap>&nbsp;
																            			<select name="enable" id="enable">
																            				<option value="1" <% if(vo.getEnable()==1) out.print("selected");%>>是</option>
																            				<option value="0"<% if(vo.getEnable()==0) out.print("selected"); %>>否</option>
																            			</select>
																            		</TD>
																			</tr>
																			<tr style="background-color: #ECECEC;">
																				<TD nowrap align="right" height="24">检查日志个数&nbsp;</TD>				
																            		<TD nowrap>&nbsp;
																            			<select name="logflg" id="logflg">
																            				<option value="1" <% if(vo.getLogflg()==1) out.print("selected");%>>是</option>
																            				<option value="0"  <% if(vo.getLogflg()==0) out.print("selected");%>>否</option>
																            			</select>
																            		</TD>
																			</tr>
																			<tr style="background-color: #ECECEC;">
																				<TD nowrap align="right" height="24">jid&nbsp;</TD>				
																            		<TD nowrap>&nbsp;
																            			<select name="jid" id="jid">
																            				<option value="1" <% if(vo.getJid()==1) out.print("selected");%>>是</option>
																            				<option value="0"<% if(vo.getJid()==0) out.print("selected");%>>否</option>
																            			</select>
																            		</TD>
																			</tr>
																			<tr>
