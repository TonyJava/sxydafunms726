...
<%@page import="com.afunms.application.course.model.LsfHostNode"%>
...
<html>
	<head>
		...
		<script type="text/javascript">
			var listAction = "<%=rootPath%>/lsfprocessnode.do?action=netip";
		...
		<script type="text/javascript">
			...
			function submitip(){
				window.opener.document.getElementById("nodeid").value=radiochk();
	 			window.close();
			}
		</script>
	</head>
		        											...
		        											<table cellspacing="0" border="1" bordercolor="#ababab">
		        												...
		        												<%
			        												...
			        												for (int i = 0; i < list.size(); i++) {
																		vo = (LsfHostNode) list.get(i);
			        													%>
			        													<tr <%=onmouseoverstyle%>>
											        						<td align='center'>
											        							<input type="radio" name="nodeid" class="noborder" value="<%=vo.getId()%>"><%=vo.getIp_address()%>
																			</td>
