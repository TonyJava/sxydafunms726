					        									    ...
					        									    if(list!=null&& list.size()>0){
					        									        ...
					        									        for(int i = 0 ; i < list.size() ; i++){
					        									            ...
					        									            <tr <%=onmouseoverstyle%>>
								        										...
								        										<td align="center" class="body-data-list"><img src="<%=rootPath%>/resource/image/status.gif" border="0" width="15" alt="右键操作" oncontextmenu=showMenu('2','<%=hostServiceGroup.getId()%>','<%=hostServiceGroup.getNodeid()%>')></td>
								        									</tr>
					        									            <% 
					        									            	}
					        									            }
