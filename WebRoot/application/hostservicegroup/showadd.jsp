...
function chooseHostService(eventId){
	...
	if( ipaddress.value && nodeid.value){
		return CreateWindow('<%=rootPath%>/hostservicegroup.do?action=chooseHostService&ipaddress=' + ipaddress.value + '&nodeid=' + nodeid.value + '&eventId='+nodeid.value);
	}
	alert("请先选择设备");
	return;
}
	function showup(){
				var url="<%=rootPath%>/hostservicegroup.do?action=allip";
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title"> 应用 &gt;&gt; 服务组管理 &gt;&gt; 添加 </td>
				        														...
				        														<td>
				        															<table>
																						<tr>						
																							...
																							<td width="40%">&nbsp;<input type="text" id="ip" readonly="readonly" name="ip">
																							
																							<input type="button" value="选择主机服务器"
																						onclick="showup()">
																							</td>
																						</tr>														
																						<tr>						
