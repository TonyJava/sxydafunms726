				  ...
				  <table border="0" id="table1" cellpadding="0" cellspacing="1"
					...
					<TBODY>
					    ...
					    <tr style="background-color: #ECECEC;">
							...
							<TD nowrap>&nbsp;<%=SysUtil.ifNull(vo.getIpAddress())%></TD>	
						</tr>
						<tr>								
							<TD nowrap align="right" height="24">类型&nbsp;</TD>				
							<TD nowrap>&nbsp;<%=NodeHelper.getNodeCategory(vo.getCategory())%></TD>							
						...
						<tr style="background-color: #ECECEC;">
						    ...
						    <TD nowrap align="right" height="24">共同体&nbsp;</TD>				
							<TD nowrap>&nbsp;<%=vo.getCommunity()%></TD>							
						<tr>	
							<TD nowrap align="right" height="24">系统描述&nbsp;</TD>				
							<TD nowrap>
							<textarea name="sys_descr" cols="50" rows="8" class="formStyle" readonly><%=vo.getSysDescr()%></textarea></TD>											
						</tr>
						<tr>
