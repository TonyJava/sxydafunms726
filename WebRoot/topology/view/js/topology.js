...
{	
	...
	for (var i = 0; i < nodes.length; i += 1)
	{
		...
		document.all("node_" + id).ondblclick = function() {
			                                     if(this.name!=""){
			                                     	 parent.mainFrame.location = "../view/change.jsp?customview=" + this.name;
			                                     	 //parent.location = "../view/custom.jsp?customview=" + this.name;
			                                     }else{
	...
	for (var j = 0; j < lines.length; j += 1)
	{
		...
		line.onmousemove = function(e) { 
		                       ...
		                       window.event.srcElement.strokeweight = 2; 
		...
		line.onmouseout = function() { 
		                      window.event.srcElement.strokeweight = 1; 
