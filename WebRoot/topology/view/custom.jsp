...
<frame src="<%=rootPath%>/topology/view/topFrame.jsp?fullscreen=<%=fullScreen%>" name="topFrame" scrolling="No" noresize="noresize" id="topFrame" title="工具栏" />
<frame src="<%=rootPath%>/topology/view/showMap.jsp?fullscreen=<%=fullScreen%>" name="mainFrame" scrolling="No" noresize="noresize" id="mainFrame" title="网络设备视图" />
</frameset>
</html>