			...
			//alert(this.name);
		                                   ...
		                                   //	alert("000--");
		                                         	 ...
		                                         	 if(this.name.substring(0,this.name.lastIndexOf(","))=="network.jsp"){
		                                         	 	//alert("901行"+"222");
		                                         	     window.parent.parent.location = "../network/index.jsp";
		                                         	     // parent.mainFra3me.location.reload();
		                                         	 }else{
		                                         	 	//alert("901行"+"333");
		                                         	 	//alert(this.name.indexOf("#"));
		                                         	 	if(this.name.indexOf("#")>-1)
		                                         	 	{
		                                         	     //
														// window.parent.parent.location ="../../cabinetshow.do?action=list&roomId=2&jp=1";
														 //cabinetshow.do?action=list&roomId="+value+"&jp=1";
