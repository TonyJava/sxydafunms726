              ...
              <tr> 
                ...
                <table width="1" height="1" border="1" cellpadding="0" cellspacing="0" bordercolor="397DBD">
                    <tr align="left" bgcolor="397dbd"> 
                      ...
                      <td width="300" height="23" background="images/yemian_16.gif" align=right><font color="#FFFFFF"><!--当前利用率:<%=str1%>  &nbsp;&nbsp;-->平均:<%=cpuavg%>  &nbsp;&nbsp;最大:<%=str2%>&nbsp;</font>
                        </td>                        
                    </tr>
                    <tr> 
                      <td colspan=2><i> 
                        <table width="742" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td bgcolor="#FFFFCC" align=center><img src="<%=imgurl.get("cpu").toString()%>"></td>
                          </tr>
                        </table>
                        </i></td>
                    </tr>
