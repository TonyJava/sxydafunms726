...
function save()
{
    ...
    if(chk1&&chk2){
        args.parent.mainFrame.editNode(ipaddress,alias);
        window.close(); 
    }
}
...
<table border="0" id="table1" cellpadding="0" cellspacing="0" width=350px>
	<tr>
		...
		<table width="350px" border=0 cellpadding=0 cellspacing=0>
			...
			<TD nowrap width="80%">
			   &nbsp; <input type="text" name="ipaddress" size="30" class="formStyle" value="<%=ip%>">
			   <font color="red">&nbsp;*</font>
			</TD>
			</tr>
			<tr>						
			...
			<TD nowrap width="80%">
			   &nbsp; <input type="text" name="alias" size="30" class="formStyle" value="<%=alias%>">
			   <font color="red">&nbsp;*</font>
			</TD>
			</tr>
			<tr>
