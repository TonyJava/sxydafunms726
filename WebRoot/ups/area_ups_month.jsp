...
String obj1 = (String)request.getParameter("obj1");
String obj2 = (String)request.getParameter("obj2");
String obj3 = (String)request.getParameter("obj3");
              							...
              							<tr> 
                							<td width="100%" > 
												...
												<script type="text/javascript">
													var so = new SWFObject("<%=rootPath%>/flex/Area_Ups_month.swf?ipadress=<%=ip%>&id=<%=id%>&table=<%=table%>&flag=<%=tag%>&obj1=<%=obj1%>&obj2=<%=obj2%>&obj3=<%=obj3%>", "Area_Ups_month", "800", "250", "8", "#ffffff");
