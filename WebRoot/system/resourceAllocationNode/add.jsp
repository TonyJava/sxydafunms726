...
<html>
	...
	*/		
	function toSave(){
		mainForm.action = "<%=rootPath%>/resourceConfigNode.do?action=save&id=<%=agentid%>";
		mainForm.submit();
	}
</script>
		<script language="JavaScript" type="text/JavaScript">
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 系统管理 >> 维护期设置 >> 设置列表 >> 资源选择 >> 尚未分配 </td>
																...
																<%
																	if(list != null && list.size() > 0) {
																		for(int i = 0; i < list.size(); i++){
																			ResourceConfNode agentnode=(ResourceConfNode)list.get(i);
																%>
																<tr>
