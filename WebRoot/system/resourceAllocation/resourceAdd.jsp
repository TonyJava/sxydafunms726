...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk2 = checkinput("startdate","string","开始日期",50,false);
     var chk3 = checkinput("todate","string","截至日期",50,false);
     var chk4 = checkinput("state","int","状态",10,false);
																		...
																		<table border="0" id="table1" cellpadding="0"
																			...
																			<tr style="background-color: #ECECEC;">
																				...
																				<TD>
																					...
																					<select id="state" size=1 name='state' style='width:108px;'><option value=0 selected>活动</option><option value=1>停止</option></select>
																				</TD>
																				<TD nowrap align="right" height="24" width="10%">
																					描述
																				</TD>
