...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function submitip(){
				window.opener.document.getElementById("ip").value=radiochk();
	 			window.close();
			}
		</script>
	</head>
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">全部设备 IP列表</td>
		        											...
		        											<table cellspacing="0" border="1" bordercolor="#ababab">
		        												...
		        												<%
			        												...
			        												for (int i = 0; i < list.size(); i++) {
			        													...
			        													<tr <%=onmouseoverstyle%>>
											        						<td align='center'>
											        							<input type="radio" class="noborder" name="ipaddress" value="<%=vo.getIpAddress()%>"><%=vo.getIpAddress()%>
																			</td>
