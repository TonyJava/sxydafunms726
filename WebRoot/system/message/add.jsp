...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     {      
        	...
        	mainForm.action = "<%=rootPath%>/message.do?action=add";
        	mainForm.submit();
     }
       // mainForm.submit();
 });	
																	...
																	<td>
																		<table border="0" id="table1" cellpadding="0"
																			...
																			<tr>
																				...
																				<TD>
																					<input type="text" name="bigsys" id="bigsys" size="40">
																				</TD>
																			</tr>
																			<tr style="background-color: #ECECEC;">
																				<TD nowrap align="right" height="24" width="40%">
																				...
																				<TD>
																					<input type="text" name="smallsys" id="smallsys" size="40">
																				</TD>
																			</tr>
																			<tr>
