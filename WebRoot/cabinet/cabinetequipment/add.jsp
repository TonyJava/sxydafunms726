					...
					<TBODY>
						...
						<tr style="background-color: #ECECEC;" id='community_tr'>				
							...
							<!--
								...
								<input type="hidden" name="businessName" id="businessName" maxlength="50" size="20" class="formStyle" value="">
								<input type="hidden" name="bid" id="bid" maxlength="50" size="20" class="formStyle" value="">
								</TD>	
								-->	
							  
							<TD nowrap style="display:none" align="right" height="24" width="10%">所属业务系统&nbsp;</TD>				
							<TD nowrap style="display:none" width="40%" >&nbsp;
