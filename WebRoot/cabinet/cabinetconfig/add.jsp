																	...
																	<td>
																		<table cellspacing="1">
																			...
																			<tr style="display:none">
																				...
																				<td width="40%">&nbsp;<input type="text" id="standards" name="standards" value="1"></td>
																				<td align="right" height="24" width="10%">电源个数:&nbsp;</td>
																				<td width="40%">&nbsp;&nbsp;<input type="text" id="powers" name="powers" value="1"></td>
																			</tr>
																			<tr style="display:none">
																				<td align="right" height="24" width="10%">高度(CM):&nbsp;</td>
																				<td width="40%">&nbsp;<input type="text" id="heights" name="heights" value="1"></td>
																				<td align="right" height="24" width="10%">宽度(CM):&nbsp;</td>
																				<td width="40%">&nbsp;&nbsp;<input type="text" id="widths" name="widths" value="1"></td>
																			</tr>
																			<tr style="background-color: #ECECEC;">
																				<td style="display:none" align="right" height="24" width="10%">深度(CM):&nbsp;</td>
																				<td style="display:none" width="40%">&nbsp;<input type="text" id="depths" name="depths" value="1"></td>
