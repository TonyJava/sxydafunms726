...
function query(){
	...
	mainForm.action = "<%=rootPath%>/monitor.do?action=hostresponsetime_report&id=<%=id%>";
	mainForm.submit();
}
    ...
    <td><i>
	    <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="98C4F1" id="table2">
	  	...
	  	<tr>
			...
			<td bgcolor="#FFFFFF" align=center><img src='<%=rootPath%>/<%=imgurl.get("ResponseTime").toString()%>?temp=<%=Math.random()%>'></td>
