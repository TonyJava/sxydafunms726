...
<%  
  ...
  String chart1 = null,chart2 = null,chart3 = null,chart4 = null,chart5 = null,responseTime = null;  
  ...
  if(item1.getSingleResult()!=-1)
  {
     ...
     CommonItem item2 = (CommonItem)host.getItemByMoid(MoidConstants.TRU64_CPU);
     if(item2!=null && item2.getSingleResult()!=-1)
     {
         chart2 = ChartCreator.createMeterChart(item2.getSingleResult(),"",150,150);  
     }  
     CommonItem item3 = (CommonItem)host.getItemByMoid(MoidConstants.TRU64_MEMORY);
     if(item3!=null&&item3.getSingleResult()!=-1)
     chart3 = ChartCreator.createMeterChart(item3.getSingleResult(),"",150,150);  
     
     CommonItem item4 = (CommonItem)host.getItemByMoid(MoidConstants.TRU64_FILE_SYSTEM);     
     if(item4!=null&&item4.getMultiResults()!=null)
     {
         ...
         chart4 = ChartCreator.createStackeBarChart(dataset,"文件系统","利用率(%)","文件系统利用率",200,200);            
     }
     CommonItem item5 = (CommonItem)host.getItemByMoid(MoidConstants.TRU64_DIR);     
     if(item5!=null&&item5.getMultiResults()!=null)
     {
         transformer.item2Array(item5.getMultiResults());
         CategoryDataset dataset = DatasetUtilities.createCategoryDataset(transformer.getYKey(),transformer.getXKey(),transformer.getData());
         chart5 = ChartCreator.createStackeBarChart(dataset,"目录","利用率(%)","目录占用率",200,200);            
     }     
  }  
  else
    responseTime = "无响应"; 
...
<td align="center"><table style="BORDER-COLLAPSE: collapse" borderColor=#cedefa 
                  cellPadding=0 rules=none width=90% align=center border=1 algin="center" height=95%>
                      <tr>
                        <td align="center" valign="middle" height='30'>
<%if(chart5!=null){%>                           
                        <img src="<%=rootPath%>/artist?series_key=<%=chart5%>">
<%} else out.print("无数据!");%>                                                
                        </td>                       
                      </tr>
                    </table></td>                                        
