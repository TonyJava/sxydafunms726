  												...
  												<tr align="center" bgcolor="#ECECEC"> 
  													<td  width="5%" align="center"><div>&nbsp;ID</div></td>
    													...
    													<td  width="10%" align="center"><div> 登录封锁 </div></td>
             											...
             											int i = 0;
             												while (it.hasNext()) {
             													F5Session f5Session = (F5Session)it.next(); ;
             											%>
            											<tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>>
            												<td height=28 class="detail-data-body-list" >&nbsp;&nbsp;
	            												<%=++i%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=f5Session.getNumSessions()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=f5Session.getSuccessLogin()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=f5Session.getSuccessLogout()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=f5Session.getFailureLogin()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=f5Session.getTotalBytesIn()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=f5Session.getTotalBytesOut()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=f5Session.getMaxActiveSessions()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=f5Session.getErrorLogin()%></td>
            												<td height=28 class="detail-data-body-list" align="center"><%=f5Session.getLockOutLogin()%></td>
            											</tr>
            											<%
