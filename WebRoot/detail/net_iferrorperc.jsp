...
<div align="center"><a href="<%=rootPath%>/monitor.do?action=show_errorsperc&ipaddress=<%=ipaddress%>&ifindex=<%=index%>&ifname=<%=ifname%>"><font color="#ffffff">端口错误率</font></a></div></td>
    <td width="74" background="<%=rootPath%>/resource/image/anjian_1.gif">
          ...
          <td>
                <table width="1" height="1" border="0" cellpadding="0" cellspacing="0" bordercolor="397DBD">
                    <tr align="left" bgcolor="397dbd"> 
                      <td width="100%" height="23" background="<%=rootPath%>/resource/image/yemian_16.gif">&nbsp;<b><font color="#FFFFFF">端口错误率&nbsp;&nbsp; 
                    ...
                    <tr> 
                      <td ><i> 
                        <table width="742" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td bgcolor="#FFFFCC" align=center><img src="<%=rootPath%>/<%=imgurl.get("errorperc").toString()%>"></td>
                          </tr>
                        </table>
                        </i></td>
                    </tr>
