...
<script language="JavaScript" type="text/javascript">
  ...
  function doEdit()
  {
     if ( mainForm.viewlines.options.length == 0 )
     {
       alert("下拉框为空,请增加记录!")
       return false;
     }
     ...
     var len = mainForm.viewlines.options.length; //右边下拉框全选
     for ( i=0 ; i < len; i++ )
        mainForm.viewlines.options[i].selected = true;

     mainForm.action = "<%=rootPath%>/customview.do?action=edit_lines";
     mainForm.submit();
  }
	...
	<tr>
		<td width="200" valign=top align=center>
			...
			<table width="90%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none w align=center border=1 algin="center">
                        <tbody>                     										                        								
                    		...
                    		<tr align="left" valign="center"> 
                    			<td height="28" align="left">&nbsp;<img src="<%=rootPath%>/resource/image/manageDev.gif" border=0>&nbsp;<a href="<%=rootPath%>/network.do?action=list?jp=1">设备列表</td>
                    		</tr> 
                    		<tr align="left" valign="center"> 
                    		...
                    		<tr align="left" valign="center"> 
                    			<td height="28" align="left">&nbsp;<img src="<%=rootPath%>/resource/image/manageDev.gif" border=0>&nbsp;<a href="<%=rootPath%>/link.do?action=list">链路信息</td>
                    		</tr>                    		                      		                   		                   										                 										                      								
            		</tbody>
            		</table> 
            		<br>
			<table width="90%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none w align=center border=1 algin="center">
                        <tbody>                     										                        								
                    		...
                    		<tr align="left" valign="center"> 
                    			<td height="28" align="left">&nbsp;<img src="<%=rootPath%>/resource/image/editicon.gif" border=0>&nbsp;<a href="<%=rootPath%>/network.do?action=monitornodelist&jp=1">监视对象一览表</td>
                    		</tr> 
                    		<tr align="left" valign="center"> 
                    			<td height="28" align="left">&nbsp;<img src="<%=rootPath%>/resource/image/manageDev.gif" border=0>&nbsp;<a href="<%=rootPath%>/moid.do?action=allmoidlist">指标全局阀值一览表</td>
                    		</tr> 
                    		<tr align="left" valign="center"> 
			...
			<table width="90%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none w align=center border=1 algin="center">
                        <tbody>                     										                        								
                    		...
                    		<tr align="left" valign="center"> 
                    			<td height="28" align="left">&nbsp;<img src="<%=rootPath%>/resource/image/task.gif" border=0>&nbsp;<a href="<%=rootPath%>/customxml.do?action=list&jp=1">视图编辑</td>
                    		</tr> 
                    		<tr align="left" valign="center"> 
                    			<td height="28" align="left">&nbsp;<img src="<%=rootPath%>/resource/image/menu.gif" border=0>&nbsp;<a href="javascript:void(null)" onClick='window.open("<%=rootPath%>/topology/view/custom.jsp","fullScreenWindow", "toolbar=no,height="+ window.screen.height + ","+"width=" + (window.screen.width-8) + ",scrollbars=no"+"screenX=0,screenY=0")'>视图展示</td>
                    		</tr>                    		                   										                 										                      								
            		</tbody>
            		</table> 		
		...
		<td bgcolor="#cedefa" align="center" valign=top>
			<table width="98%" style="BORDER-COLLAPSE: collapse" borderColor=#397DBD cellPadding=0 rules=none align=center border=1 algin="center">
				<tr>
					<td height="28" align="left" bordercolor="#397DBD" bgcolor="#397DBD" class="txtGlobalBold" colspan=3>&nbsp;&nbsp;资源 >> 视图管理 >> 定制视图 >> 编辑连线</td>
				</tr>
			<tr>
...
<!--=================================-->
       <tr><td align='center'><table>
          	<tr  borderColor=#cedefa height="32">
			   <td align="center">
			      <select name="viewlines" size="10" style="width:500px;" multiple></select>
			   </td></tr>
			   <tr><td height='20'>&nbsp;</td></tr>
			   <tr><td align="center">
			     起点&nbsp;&nbsp;<select name="startnodes" style="width:200px;"></select><--->
			     终点&nbsp;&nbsp;<select name="endnodes" style="width:200px;"></select>
               </td></tr>	
               <tr><td height='20'>&nbsp;</td></tr>			
			   <tr><td align="center">
					<a href="#" onclick="addALine()">增加</a>
					<a href="#" onclick="delALine()">删除</a>			   
               </td></tr>               
       </table></td></tr>
<!--=================================-->
						<tr align=center>
