...
<script language="javascript">
  ...
  function toReport()
  {
     mainForm.action = "<%=rootPath%>/ups.do?action=server_jsp&menu=0802";
     mainForm.submit();
  }
...
<table width="85%" align="center" border="0" height="24">
    <tr>
       ...
       <td align="right" width="40%">
          <a href="<%=rootPath%>/ups.do?action=server_pdf&day=<%=day%>" target="_blank"><img name="selDay1" alt='导出PDF' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_pdf.gif" width=30 height=32 border="0"></a>
          &nbsp;&nbsp;&nbsp;
          <a href="<%=rootPath%>/ups.do?action=server_excel&day=<%=day%>" target="_blank"><img name="selDay1" alt='导出EXCEL' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_excel.gif" width=30 height=32 border="0"></a>
       </td>      
    </tr>
</table><br>
<!--**************************************服务器报表******************************************-->
