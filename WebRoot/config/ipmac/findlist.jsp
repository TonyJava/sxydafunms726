...
<table border="0" id="table1" cellpadding="0" cellspacing="0" width=100%>
 ...
 <tr>
		<td align=right bgcolor="#ECECEC">
				<a href="<%=rootPath%>/ipmac.do?action=downloadipmacfindreportall" target="_blank"><img name="selDay1" alt='导出EXCEL' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_excel.gif" width=18  border="0">导出EXCEL</a>&nbsp;&nbsp;&nbsp;&nbsp;
