											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 自动化 >> 自动化控制 >> 设备开关机审计列表</td>
		        											...
		        											<table cellspacing="0" border="1" bordercolor="#ababab">
			        											...
			        											%>
			        													<tr <%=onmouseoverstyle%>>
    	                                                                    ...
    	                                                                    <td align='center'><a href="#"  style="cursor:hand" onclick="window.showModalDialog('<%=rootPath%>/user.do?action=read&id=<%=vo.operid%>',window,',dialogHeight:400px;dialogWidth:600px')"><%=vo.getOper_user()%></td></a>
