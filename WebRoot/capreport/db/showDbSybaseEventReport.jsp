...
function ping_ok()
{
	...
	mainForm.action = "<%=rootPath%>/sybase.do?action=sybaseManagerEventReportQuery&ipaddress=<%=ip%>&startdate="+starttime+"&todate="+endtime+"&id="+<%=id%>+"&status="+status+"&level1="+level1;
	mainForm.submit();
}
