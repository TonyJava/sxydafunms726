...
function ping_ok()
{
	...
	mainForm.action = "<%=rootPath%>/sqlserver.do?action=SqlServerManagerEventReportQuery&ipaddress=<%=ip%>&startdate="+starttime+"&todate="+endtime+"&id="+<%=id%>+"&status="+status+"&level1="+level1;
	mainForm.submit();
}
