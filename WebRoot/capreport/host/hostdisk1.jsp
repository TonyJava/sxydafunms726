	...
	<input type=hidden name="orderflag">
                					...
                					<td>
  									...
  									<tr>
  										<td>主机服务器磁盘利用率报表&nbsp;&nbsp;时间段:&nbsp;<%=(String)request.getAttribute("starttime")%>&nbsp;至&nbsp;<%=(String)request.getAttribute("totime")%>
											...
											<a href="<%=rootPath%>/diskincrease.do?action=downloaddiskreport&startdate=<%=startdate%>&todate=<%=todate%>" target="_blank"><img name="selDay1" alt='导出EXCEL' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_excel.gif" width=18  border="0">导出EXCEL</a>&nbsp;&nbsp;&nbsp;&nbsp;
    	...
    	<td align=center bgcolor=white width=15%>IP地址</td>
		  ...
		  <td align=center bgcolor=white width=10%>
			...
			<td align=center bgcolor=white width=10%>增长率</td>
   												</tr>
