...
function setClass(){
	document.getElementById('hostReportTitle-6').className='detail-data-title';
	document.getElementById('hostReportTitle-6').onmouseover="this.className='detail-data-title'";
	document.getElementById('hostReportTitle-6').onmouseout="this.className='detail-data-title'";
}
...
<body id="body" class="body" onload="initmenu();">
	...
	<input type=hidden name="orderflag">
							...
							<td class="td-container-main-report">
								<table id="container-main-report" class="container-main-report">
                					...
                					<td>
                						...
                						<table>
  									<tr>
  										<td>主机服务器忙时CPU利用率报表&nbsp;&nbsp;时间段:&nbsp;<%=(String)request.getAttribute("starttime")%>&nbsp;至&nbsp;<%=(String)request.getAttribute("totime")%>
  										</td>
  									
                      								<td align=right valign=top>&nbsp;&nbsp;
                      								<a
																href="<%=rootPath%>/hostreport.do?action=createpdfbusytimeCpu"><img
																	name="selDay1" alt='导出word' style="CURSOR: hand"
																	src="<%=rootPath%>/resource/image/export_pdf.gif"
																	width=18 border="0">导出PDF</a>&nbsp;&nbsp;&nbsp;&nbsp;
															<a
																href="<%=rootPath%>/hostreport.do?action=createdocbusytimeCpu"><img
																	name="selDay1" alt='导出word' style="CURSOR: hand"
																	src="<%=rootPath%>/resource/image/export_word.gif"
																	width=18 border="0">导出WORLD</a>&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="<%=rootPath%>/hostreport.do?action=downloadcpubusytimereport&startdate=<%=startdate%>&todate=<%=todate%>" target="_blank"><img name="selDay1" alt='导出EXCEL' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_excel.gif" width=18  border="0">导出EXCEL</a>&nbsp;&nbsp;&nbsp;&nbsp;
                      										&nbsp;&nbsp;
                      								</td> 
                      							</tr>
                      							</table>
    	...
    	<td align=center bgcolor=white width=20%>IP地址</td>
		  ...
		  <td align=center bgcolor=white width=15%>平均值(%)</td>
		  <td align=center bgcolor=white width=15%>最大值(%)</td>
		  <td align=center bgcolor=white width=15%>忙时总时间(分)</td>
...
<%
			...
			List cpulist = (List)request.getAttribute("list");
