...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
	...
	mainForm.action="<%=rootPath%>/diskincrease.do?action=topAlarm&jp=<%=jp%>";
	//alert(1);
	mainForm.submit();        
...
function setClass(){
	document.getElementById('topReportTitle-<%=jp%>').className='detail-data-title';
	document.getElementById('topReportTitle-<%=jp%>').onmouseover="this.className='detail-data-title'";
	document.getElementById('topReportTitle-<%=jp%>').onmouseout="this.className='detail-data-title'";
}
				        												...
				        												<tr>
															  				<td>
																				...
																				<table id="report-data-header-title" class="report-data-header-title">
																					...
																					<tr>
  										<td>服务器告警报表&nbsp;&nbsp;时间段:&nbsp;<%=(String)request.getAttribute("starttime")%>&nbsp;至&nbsp;<%=(String)request.getAttribute("totime")%>
  										</td>
  									
                      								<td align=right valign=top>
                      								&nbsp;&nbsp;
															
											<a href="<%=rootPath%>/diskincrease.do?action=downloadtopreport&startdate=<%=startdate%>&todate=<%=todate%>&jp=<%=jp%>" target="_blank"><img name="selDay1" alt='导出EXCEL' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_excel.gif" width=18  border="0">导出EXCEL</a>&nbsp;&nbsp;&nbsp;&nbsp;
									    	...
									    	<td  class="report-data-body-title"><strong>告警数</strong></td>
									   </tr>
									<%
									    	int index = 0;
			List disklist = (List)request.getAttribute("alarmlist");
