													...
													<table bgcolor="#ECECEC" width="100%">
														<tr align="left" valign="center"> 
															...
															<td height="28" align="left" width="10%">
																<a href="javascript:disk_word_report()"><img name="selDay1" alt='导出word' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_word.gif" width=18  border="0">导出WORLD</a>
															</td>
															<td height="28" align="left" width="10%">
