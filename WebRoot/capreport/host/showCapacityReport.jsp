...
function capacity_ok()
{
	...
	mainForm.action = "<%=rootPath%>/hostreport.do?action=showCapacityReport&ipaddress=<%=ipaddress%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
											...
											<tr>
						       					<td>
													<table bgcolor="#ECECEC">
														...
														<td height="28" align="left">
															<a href="javascript:capacity_word_report()"><img name="selDay1" alt='导出word' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_word.gif" width=18  border="0">导出WORLD</a>
														</td>
														<td height="28" align="left">
