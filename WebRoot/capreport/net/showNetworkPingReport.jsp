			...
			<td>
				<table id="container-main-win" class="container-main-win">
					<tr>
											...
											<tr>
						       					<td>
													<table bgcolor="#ECECEC">
														...
														<td height="28" align="left">
															<a href="javascript:network_ping_word_report()"><img name="selDay1" alt='导出word' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_word.gif" width=18  border="0">导出WORLD</a>
														</td>
														<td height="28" align="left">
						...
						<tr bgcolor="">
							<td colspan="12" align="center" style="font-size: 20"><br><b>主机服务连通率报表<br><br></td>
						</tr>
