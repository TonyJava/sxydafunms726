...
function network_event_ok()
{
	...
	mainForm.action = "<%=rootPath%>/netreport.do?action=showEventReport&ipaddress=<%=ipaddress%>&startdate="+starttime+"&todate="+endtime;
	mainForm.submit();
}
											...
											<tr>
						       					<td>
													<table bgcolor="#ECECEC">
														...
														<td height="28" align="left">
															<a href="javascript:network_event_word_report()"><img name="selDay1" alt='导出word' style="CURSOR:hand" src="<%=rootPath%>/resource/image/export_word.gif" width=18  border="0">导出WORLD</a>
														</td>
														<td height="28" align="left">
