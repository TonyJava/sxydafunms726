  ...
  public BaseVo findByID(String id)
  {
   ...
   public BaseVo loadFromResultSet(ResultSet rs)
   {
	...
	public Map getCountByUserAccout(String ipaddress, String starttime, String totime,
			String msgRegexp) {
		String where = " where ipaddress = '" + ipaddress + "' and recordtime >= '" + starttime + "' and recordtime <= '" + totime + "' and " + msgRegexp; 
	...
	public int getCountByEvent(String ipaddress, String starttime, String totime, String eventMsg) {
		String sql = "select count(*) from nms_netsyslog where ipaddress = '" + ipaddress + "' and recordtime >= '" + starttime + "' and recordtime <= '" + totime + "' and " + eventMsg;
		rs = conn.executeQuery(sql);
		try {
			if (rs.next()) {
				return rs.getInt(1);
