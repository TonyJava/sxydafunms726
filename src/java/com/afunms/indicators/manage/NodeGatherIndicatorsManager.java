...
public class NodeGatherIndicatorsManager extends BaseManager implements ManagerInterface
{
	...
	public String add(){
		...
		try {
			...
			List gatherIndicatorsList = gatherIndicatorsUtil.getGatherIndicatorsByTypeAndSubtype(type, subtype,isDefalut);
...
//		NodeGatherIndicators nodeGatherIndicators = createGatherIndicators();
	...
	public String multichange(){
		...
		nodeGatherIndicatorsUtil.deleteNodesGatherIndicators(nodeids);
