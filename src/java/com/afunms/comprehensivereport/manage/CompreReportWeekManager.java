...
ManagerInterface {
	...
	public String reportWeekList(){
		...
		return "/capreport/comprehensive/compreReportWeek.jsp";
	}
	public String compreReportWeekConfig(){
		...
		return "/capreport/comprehensive/compreReportWeekDetail.jsp";
	}
	public String downloadReportWeek(){
		...
		if ("hostNet".equalsIgnoreCase(type)) {
			if (exportType.equals("xls")) {
				filename="/temp/compreWeek_report.xls";
			}else if (exportType.equals("doc")) {
				filename="/temp/compreWeek_report.doc";
			}else if (exportType.equals("pdf")) {
				filename="/temp/compreWeek_report.pdf";
			}
		}
		...
		export.exportReportByDay(ids, type,reportType, filePath, weekDay,exportType,null);
