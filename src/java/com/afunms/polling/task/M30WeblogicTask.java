...
public class M30WeblogicTask extends MonitorTask {
	
	public void run() {
		SysLogger.info("#### 开始执行WEBLOGIC的30分钟采集任务 ####");
		try{
	    	...
	    	try{
	    		...
	    		monitorItemList = indicatorsdao.getByInterval("30", "m",1,"middleware","weblogic");
	    	}catch(Exception e){
	    		e.printStackTrace();
	    	}finally{
	    		indicatorsdao.close();
			...
			SysLogger.info("#### M30WEBLOGICTask Thread Count : "+Thread.activeCount()+" ####");
		}
	}
