...
public class M10WasTask extends MonitorTask {
	
	public void run() {
		SysLogger.info("#### 开始执行Was的10分钟采集任务 ####");
		try{
	    	...
	    	try{
	    		...
	    		monitorItemList = indicatorsdao.getByInterval("10", "m",1,"middleware","was");
	    	}catch(Exception e){
	    		e.printStackTrace();
	    	}finally{
	    		indicatorsdao.close();
			...
			SysLogger.info("#### M10WasTask Thread Count : "+Thread.activeCount()+" ####");
		}
	}
...
//            	HostCollectDataManager hostdataManager=new HostCollectDataManager(); 
            	...
            	SysLogger.info("##############################");
            	SysLogger.info("### 开始采集ID为"+dbid+"的Was数据 ");
            	SysLogger.info("##############################");
