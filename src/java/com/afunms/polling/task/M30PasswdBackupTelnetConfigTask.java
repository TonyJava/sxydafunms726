...
//		System.gc();
	...
	private void subscribe() { 
		...
		String sql = "SELECT * FROM sys_passwdtimingbackup_telnetconfig s WHERE status = '是' and s.BACKUP_DATE > 10000 AND s.BACKUP_DATE < "
				+ time;
						...
						if(!telnetconfigips.equals("") && telnetconfigips != null){
							...
							for(String ip : ips){
								if(ip != null && !ip.equals("") && !ip.equals(",") && "是".equals(status)){
									...
									List<AlarmWayDetail> list = getAlarmWayDetail("126");
