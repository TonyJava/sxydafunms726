...
public class M10InformixTask extends MonitorTask {
	
	public void run() {
		SysLogger.info("#### 开始执行Informix的10分钟采集任务 ####");
		try{
	    	...
	    	try{
	    		...
	    		monitorItemList = indicatorsdao.getByInterval("10", "m",1,"db","informix");
	    	}catch(Exception e){
	    		e.printStackTrace();
	    	}finally{
	    		indicatorsdao.close();
			...
			SysLogger.info("#### M10INFORMIXTask Thread Count : "+Thread.activeCount()+" ####");
		}
	}
