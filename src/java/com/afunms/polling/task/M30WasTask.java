...
public class M30WasTask extends MonitorTask {
	
	public void run() {
		SysLogger.info("#### 开始执行Was的30分钟采集任务 ####");
		try{
	    	...
	    	try{
	    		...
	    		monitorItemList = indicatorsdao.getByInterval("30", "m",1,"middleware","was");
	    	}catch(Exception e){
	    		e.printStackTrace();
	    	}finally{
	    		indicatorsdao.close();
			...
			SysLogger.info("#### M30WasTask Thread Count : "+Thread.activeCount()+" ####");
		}
	}
