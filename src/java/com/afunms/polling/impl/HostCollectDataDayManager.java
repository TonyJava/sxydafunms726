...
//						allipstr=ip1+ip2+ip3+ip4;
						...
						if((host.getCategory()>0&&host.getCategory()<4) ||host.getCategory()==7){
							...
							System.out.println("====================**&&&######day--day========================================"+allipstr);
...
//							}
							 ...
							 */
							//Ping                    
							sql="delete from ping"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(collecttime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
							...
							//Memory
							sql="delete from memory"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(collecttime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
							...
							//CPU
							sql="delete from cpu"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(collecttime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
							...
							//UtilHdx
							sql="delete from utilhdx"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(collecttime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
							...
							//UtilHdx
							sql="delete from allutilhdx"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(collecttime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
							...
							//UtilHdxPerc
							sql="delete from utilhdxperc"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(collecttime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
							...
							//DiscardsPerc
							sql="delete from discardsperc"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(collecttime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
							...
							//ErrorsPerc
							sql="delete from errorsperc"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(collecttime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
							...
							//Packs
							sql="delete from packs"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(collecttime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
							...
							//InPacks
							sql="delete from inpacks"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(collecttime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
							...
							//OutPacks
							sql="delete from outpacks"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(collecttime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
							...
							//Temper温度
							sql="delete from temper"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(collecttime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
...
//							}													
							 ...
							 */						
							//Process
							sql="delete from pro"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(collecttime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
							...
							//SYSLOG						
							sql="delete from log"+allipstr+"  where  (TO_DAYS(NOW())-TO_DAYS(recordtime)>62)";
							try{
								dbmanager.executeUpdate(sql);
							}catch(Exception e){
								e.printStackTrace();
...
//					allipstr=ip1+ip2+ip3+ip4;
					...
					try {
						...
						while (rs.next()) {
							...
							hash.put("maxin", rs.getInt("maxin"));
							hash.put("minin", rs.getInt("minin"));
						}
						rs = dbmanager.executeQuery(sqlavgout);
						while (rs.next()) {
							hash.put("agvout", rs.getInt("OutBand"));
							hash.put("maxout", rs.getInt("maxout"));
							hash.put("minout", rs.getInt("minout"));
						}
