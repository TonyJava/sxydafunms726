			...
			for(int m=0;m<processhash.size();m++)
			{
				...
				if(phash!=null){
					...
					//{
						...
						newProcessHash.put(Name+m, processInfo);
						Vector detailVect = new Vector();
						detailVect.add(newProcessInfo);
						detailHash.put(Name+m, detailVect);
					//}
				}
			}
		}
...
//		request.setAttribute("pingconavg", new Double(pingconavg));
    ...
    private String f5poolinfo()
    {
		...
		request.setAttribute("sysdescr", sysdescr);
		request.setAttribute("pingconavg", new Double(pingconavg));
		if(host.getSysOid().equalsIgnoreCase("1.3.6.1.4.1.3375.2.1.3.4.1000")||host.getSysOid().equalsIgnoreCase("1.3.6.1.4.1.7564")){
...
//		}
   ...
   public String execute(String action){
      ...
      if (action.equals("netsession")){//add by tyxdly 2015-4-7 15:48
    	  Hashtable imgurlhash=new Hashtable();
    		Vector vector = new Vector();
    		Hashtable bandhash = new Hashtable();
   ...
   private String netsession() {
		// TODO Auto-generated method stub
		return "/detail/f5_session.jsp";
	}
