 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generatiogt;Code and Comments
 */
public class IpsMemorySnmp extends SnmpMonitor {
	java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	/**
	 * 
	 */
	public IpsMemorySnmp() {
	}
...
//							memoryVector.addElement(memorycollectdata);
		   			...
		   			if(valueArray.length == 0) {
		   				//ips  oid为1.3.6.1.4.1.25506.1.416
			   			if(node.getSysOid().equals("1.3.6.1.4.1.25506.1.416") )
			   			{
			   				oids =                
								  new String[] {               
									"1.3.6.1.4.1.25506.2.6.1.1.1.1.8"//内存利用率
			   			...
			   			//acg  oid为1.3.6.1.4.1.25506.1.415
			   			if(node.getSysOid().equals("1.3.6.1.4.1.25506.1.415") )
			   			{
			   				oids =                
								  new String[] {               
									"1.3.6.1.4.1.25506.2.6.1.1.1.1.8"//内存利用率
