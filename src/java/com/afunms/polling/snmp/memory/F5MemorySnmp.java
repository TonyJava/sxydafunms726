 ...
 */
public class F5MemorySnmp extends SnmpMonitor{  
		...
		try {
				...
				Calendar date=Calendar.getInstance();
				 ...
				 try{
					  //-----------------------------------------------内存开始
					 String temp="0";
					 if (node.getSysOid().startsWith("1.3.6.1.4.1.89.1.1.62.20")){
						 String[][] valueArray=null;
						 String[] oids=
								 new String[] {
								              "1.3.6.1.4.1.89.35.1.60.23.18.1.0",                        //F5MemoryPoolUsed
								              "1.3.6.1.4.1.89.35.1.60.23.19.1.0",					   //F5MemoryPoolFree
						 };
