						...
						if(valueArray != null && valueArray.length > 0){
						   	  for(int i=0;i<valueArray.length;i++)
						   	  {
									...
									if( value >0){
										...
										//SysLogger.info(host.getIpAddress()+" ÉÁ´æ£º "+Integer.parseInt(intvalue+"")+" ×ÜÉÁ´æ:"+allvalue);
										flag = flag +1;
										...
										//SysLogger.info(host.getIpAddress()+" ÄÚ´æ£º "+Integer.parseInt(intvalue+""));
...
//							//SysLogger.info(host.getIpAddress()+" ÄÚ´æ£º "+Integer.parseInt(usedvalueperc+""));
//							flashVector.addElement(flashcollectdata);
						}	   			  
		   		  }
		   	  }
