				...
				if(ipAllData == null)ipAllData = new Hashtable();
				  ...
				  try {  
			   		  String temp = "0";
			   			...
			   			String[] oids =                
							  new String[] {               
			   					"1.3.6.1.4.1.7564.31.1.2.1.2",//sslvpn-dianxin
			   			...
			   			if(valueArray != null){
						   	  ...
						   	  {   
							   	...
							   	arrayVPNVirtualSite.setType("NET");
							   	arrayVPNVirtualSite.setSubtype("ArrayNetworks");

							   	SysLogger.info("虚拟站点:"+"virtualSiteId:"+virtualSiteId+"   virtualSiteActiveSessions:"+virtualSiteActiveSessions
