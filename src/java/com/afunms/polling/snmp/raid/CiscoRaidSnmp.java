...
//	    returnHash.put("raid", raidVector);
	    if (!(ShareData.getSharedata().containsKey(node.getIpAddress()))) {
			...
			if (ipAllData == null) ipAllData = new Hashtable();
			if (raidVector != null && raidVector.size() > 0) ipAllData.put("raid", raidVector);
				ShareData.getSharedata().put(node.getIpAddress(), ipAllData);
			} 
		else{
			if (raidVector != null && raidVector.size() > 0) ((Hashtable) ShareData.getSharedata().get(node.getIpAddress())) .put("raid", raidVector);
		}	
	    returnHash.put("raid",raidVector);
...
//			} 
//		else{
//			if (queueVector != null && queueVector.size() > 0) ((Hashtable) ShareData.getSharedata().get(node.getIpAddress())) .put("queuestatue", queueVector);
//		}	
