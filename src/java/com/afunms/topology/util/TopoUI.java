...
public class TopoUI {
	...
	public String createGallery(List<String> list, int index, int buttonStyle) {
		...
		if (buttonStyle == 0) {
			...
			buttonPanel = "<input type=\"button\" value=\"保存\" style=\"width:50\" class=\"formStylebutton\" onclick=\"save()\">" +
					"&nbsp;&nbsp;<input type=\"button\" value=\"关闭\" style=\"width:50\" class=\"formStylebutton\" onclick=\"window.close();\">";
		}

		String html = "<tr><td style=\"background-color: #ECECEC;\" nowrap align=\"right\" height=\"24\" width=\"20%\">图元类型&nbsp;</td>" +
				"<td nowrap width=\"80%\">"
				+ selectGradeOne
	...
	public String createGallery(List<String> list) {
		...
		String html = "<tr><td style=\"background-color: #ECECEC;\" nowrap align=\"right\" height=\"24\" width=\"20%\">图元类型&nbsp;" +
