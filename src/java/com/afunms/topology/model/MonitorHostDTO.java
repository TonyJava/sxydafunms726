...
public class MonitorHostDTO extends MonitorNodeDTO{
	...
	private String swapmemoryvalue;

	public String getSwapmemoryvalue() {
		return swapmemoryvalue;
	}

	public void setSwapmemoryvalue(String swapmemoryvalue) {
		this.swapmemoryvalue = swapmemoryvalue;
	}

	public String getSwapmemorycolor() {
		return swapmemorycolor;
	}

	public void setSwapmemorycolor(String swapmemorycolor) {
		this.swapmemorycolor = swapmemorycolor;
	}

	private String swapmemorycolor;
