...
//					System.out.println(sBuffer.toString());
	...
	public String getLinkUpDataByLinkId(String id,String startdate,String todate){
		String avg = "0";
		String sql = "select round(avg(thevalue),3) avg from lkuhdx"+id+" where entity='UP' and collecttime between '"+startdate+"' and '"+todate+"' ";
		try {
			...
			SysLogger.error("LinkDao.getLinkUpDataByLinkId()",e);
			e.printStackTrace();
			avg = "0";
		} finally{
			conn.close();
	...
	public String getLinkDownDataByLinkId(String id,String startdate,String todate){
		String avg = "0";
		String sql = "select round(avg(thevalue),3) avg from lkuhdx"+id+" where entity='DOWN' and collecttime between '"+startdate+"' and '"+todate+"' ";
		try {
			ResultSet rs = conn.executeQuery(sql);
			if(rs != null && rs.next()){
				avg = rs.getString("avg");
			...
			SysLogger.error("LinkDao.getLinkDownDataByLinkId()",e);
			e.printStackTrace();
			avg = "0";
		} finally{
			conn.close();
	...
	public String getLinkUsabilityDataByLinkId(String id,String startdate,String todate){
		String avg = "0";
		String sql = "select round(avg(thevalue),3) avg from lkping"+id+" where collecttime between '"+startdate+"' and '"+todate+"' ";
		try {
			ResultSet rs = conn.executeQuery(sql);
			if(rs != null && rs.next()){
				avg = rs.getString("avg");
			...
			SysLogger.error("LinkDao.getLinkUsabilityDataByLinkId()",e);
			e.printStackTrace();
			avg = "0";
		} finally{
			conn.close();
	...
	public String getLinkBandWidthDataByLinkId(String id,String startdate,String todate){
		String avg = "0";
		String sql = "select round(avg(thevalue),3) avg from lkuhdxp"+id+" where collecttime between '"+startdate+"' and '"+todate+"' ";
		try {
			ResultSet rs = conn.executeQuery(sql);
			if(rs != null && rs.next()){
				avg = rs.getString("avg");
	...
	public Map<String,Double> getLinkUpDataByLinkIdForWeek(String id,String startdate,String todate,Map<String,Double> weekValues){
		String sql = "select Date_format(collecttime,'%Y-%m-%d-%H') dat, round(avg(thevalue),3) avg from lkuhdx"+id+
		" where entity='UP' and collecttime between '"+startdate+"' and '"+todate+"' " +
				"group by Date_format(collecttime,'%Y-%m-%d-%H')";
		try {
			ResultSet rs = conn.executeQuery(sql);
			if(rs != null ){
				while(rs.next()){
					weekValues.put(rs.getString("dat"),rs.getDouble("avg"));
				}
			}
		} catch (SQLException e) {
			SysLogger.error("LinkDao.getLinkUpDataByLinkIdForWeek()",e);
			e.printStackTrace();
		} finally{
			conn.close();
		}
	...
	public Map<String,Double> getLinkDownDataByLinkIdForWeek(String id,String startdate,String todate,Map<String,Double> weekValues){
		String sql = "select Date_format(collecttime,'%Y-%m-%d-%H') dat, round(avg(thevalue),3) avg from lkuhdx"+id+
		" where entity='DOWN' and collecttime between '"+startdate+"' and '"+todate+"' " +
				"group by Date_format(collecttime,'%Y-%m-%d-%H')";
		...
		try {
			...
			SysLogger.error("LinkDao.getLinkDownDataByLinkIdForWeek()",e);
			e.printStackTrace();
		} finally{
			conn.close();
		}
	...
	public Map<String,Double> getLinkUsabilityDataByLinkIdForWeek(String id,String startdate,String todate,Map<String,Double> weekValues){
		String sql = "select Date_format(collecttime,'%Y-%m-%d-%H') dat, round(avg(thevalue),3) avg from lkping"+id+
		" where collecttime between '"+startdate+"' and '"+todate+"' " +
				"group by Date_format(collecttime,'%Y-%m-%d-%H')";
		try {
			ResultSet rs = conn.executeQuery(sql);
			if(rs != null ){
			...
			SysLogger.error("LinkDao.getLinkUsabilityDataByLinkIdForWeek()",e);
			e.printStackTrace();
		} finally{
			conn.close();
		}
	...
	public Map<String,Double> getLinkBandWidthDataByLinkIdForWeek(String id,String startdate,String todate,Map<String,Double> weekValues){
		String sql = "select Date_format(collecttime,'%Y-%m-%d-%H') dat, round(avg(thevalue),3) avg from lkuhdxp"+id+
		" where collecttime between '"+startdate+"' and '"+todate+"' " +
				"group by Date_format(collecttime,'%Y-%m-%d-%H')";
		...
		try {
			...
			SysLogger.error("LinkDao.getLinkBandWidthDataByLinkIdForWeek()",e);
			e.printStackTrace();
		} finally{
			conn.close();
		}
	...
	public String getLinkUpDataByLinkIdTop(String id,String top,String startdate,String todate){
		String avg = "0";
		String sql = "select round("+top+"(thevalue),3) value from lkuhdxhour"+id+" where entity='UP' and collecttime between '"+startdate+"' and '"+todate+"' ";
		try {
			ResultSet rs = conn.executeQuery(sql);
			if(rs != null && rs.next()){
				avg = rs.getString("value");
				avg = avg==null?"0":avg;
			}
		} catch (SQLException e) {
			SysLogger.error("LinkDao.getLinkUpDataByLinkId()",e);
	...
	public String getLinkUsabilityDataByLinkIdTop(String id,String top,String startdate,String todate){
		String avg = "0";
		String sql = "select round("+top+"(thevalue),3) value from lkpinghour"+id+" where collecttime between '"+startdate+"' and '"+todate+"' ";
		try {
			ResultSet rs = conn.executeQuery(sql);
			if(rs != null && rs.next()){
				avg = rs.getString("value");
	...
	public String getLinkDownDataByLinkIdTop(String id,String top,String startdate,String todate){
		String avg = "0";
		String sql = "select round("+top+"(thevalue),3) value from lkuhdxhour"+id+" where entity='DOWN' and collecttime between '"+startdate+"' and '"+todate+"' ";
		try {
			ResultSet rs = conn.executeQuery(sql);
			if(rs != null && rs.next()){
				avg = rs.getString("value");
	...
	public String getLinkBandWidthDataByLinkIdTop(String id,String top,String startdate,String todate){
		String avg = "0";
		String sql = "select round("+top+"(thevalue),3) value from lkuhdxphour"+id+" where collecttime between '"+startdate+"' and '"+todate+"' ";
		try {
			ResultSet rs = conn.executeQuery(sql);
			if(rs != null && rs.next()){
				avg = rs.getString("value");
