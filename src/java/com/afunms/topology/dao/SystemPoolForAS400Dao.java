...
//			systemValueForAS400.setId(rs.getInt("id"));
			...
			systemPoolForAS400.setSize(rs.getString("size"));
	...
	public boolean save(BaseVo vo) {
		...
		sql.append("insert into nms_as400_system_pool(nodeid,ipaddress,system_pool,name,size,reserved_size,maximum_active_threads,collect_time) values('");
