...
public class DiskTempDao extends BaseDao implements DaoInterface {
	...
	/*//当前月磁盘信息
	public List<NodeTemp> getCurrDiskListInfo(String nodeid, String type, String subtype, String sindex,String starttime, String endtime){
		StringBuffer sql = new StringBuffer();
		sql.append(" where nodeid='" + nodeid + "' and type='" + type + "' and subtype='" + subtype + "' and sindex = '"+sindex+"' and collecttime >='"+starttime+"' and collecttime <= '"+endtime+"' order by sindex");
		return findByCondition(sql.toString());
	}*/
	/*//上个月磁盘信息
	public List<NodeTemp>  getlastDiskListInfo(String nodeid, String type, String subtype, String sindex,String starttime, String endtime) throws ParseException{
		String start = this.getlastMonth(starttime);
		String end = this.getlastMonth(endtime);
		StringBuffer sql = new StringBuffer();
		sql.append(" where nodeid='" + nodeid + "' and type='" + type + "' and subtype='" + subtype + "' and sindex = '"+sindex+"' and collecttime >='"+starttime+"' and collecttime <= '"+endtime+"' order by sindex");
		return findByCondition(sql.toString());
	}*/
