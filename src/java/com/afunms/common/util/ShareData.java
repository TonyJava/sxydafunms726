...
public class ShareData {
  ...
  private static Hashtable resourceConfHashtable = new Hashtable();//资源维护 jhl 2012-04-05
  
  private static Hashtable mainprocessHashtable = new Hashtable();//关键进程 konglq 2012-07-05
  
  private static Hashtable submapnodeHashtable = new Hashtable();//节点管理告警表 konglq 2012-07-05
  
  public static Hashtable getSubmapnodeHashtable() {
	return submapnodeHashtable;
}

public static void setSubmapnodeHashtable(Hashtable submapnodeHashtable) {
	ShareData.submapnodeHashtable = submapnodeHashtable;
}

private static Hashtable RoomAlarmHashtable = new Hashtable();//机房是否有告警 konglq 2012-07-05
...
public static void setRoomAlarmHashtable(Hashtable roomAlarmHashtable) {
	RoomAlarmHashtable = roomAlarmHashtable;
}

private static Hashtable alarmHashtable = new Hashtable();//告警阀值 2012-08-05
  
  public static Hashtable getProcessconfigHashtable() {
	return processconfigHashtable;
}

public static void setProcessconfigHashtable(Hashtable processconfigHashtable) {
	ShareData.processconfigHashtable = processconfigHashtable;
}

private static Hashtable processconfigHashtable = new Hashtable();//进程监视列表
...
public static void setAlarmHashtable(Hashtable alarmHashtable) {
  ...
  public static Hashtable getMainprocessHashtable() {
	return mainprocessHashtable;
}

public static void setMainprocessHashtable(Hashtable mainprocessHashtable) {
	ShareData.mainprocessHashtable = mainprocessHashtable;
}
...
/**
  ...
  private static Hashtable timegatherhash;//存放按时间段采集的配置ly  add
