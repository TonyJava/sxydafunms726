...
public abstract class AbstractionReport1 {
	...
	public abstract void createReport_hostbusytimecpu(String filename);
...
//	public abstract void createReport_impevt(String filename);
	...
	public abstract void createReport_hostdiskin(String filename);
	public abstract void createReport_hosttop(String filename);
	// HONGLI END#####
	// =====================抽象类
