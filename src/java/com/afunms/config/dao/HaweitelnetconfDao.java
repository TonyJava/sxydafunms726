...
//		sql.append(vo.getUser());
	   ...
	   public boolean save(BaseVo basevo) {
		// TODO Auto-generated method stub
		   Huaweitelnetconf vo = (Huaweitelnetconf)basevo;	  
		   StringBuffer sql = new StringBuffer();
		   sql.append("insert into topo_node_telnetconfig(id,users,password,port,suuser,supassword,ip_address,default_promtp,enablevpn,is_synchronized,device_render,ostype)values(");
		   sql.append(vo.getId());
		   sql.append(",'");
		   sql.append(vo.getUser());
		   sql.append("','");
