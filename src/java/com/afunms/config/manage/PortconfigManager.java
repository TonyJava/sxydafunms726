						...
						if(ipdata != null){
							...
							if (vector !=null && vector.size()>0){
								for(int k=0;k<vector.size();k++){
									...
									if (interfaceHash.containsKey(vo.getIpaddress() + ":" + vo.getSubentity())) {
										Hashtable _porthash = (Hashtable) interfaceHash.get(vo.getIpaddress() + ":" + vo.getSubentity());
										...
										interfaceHash.put(vo.getIpaddress() + ":" + vo.getSubentity(),_porthash);
									} else {
