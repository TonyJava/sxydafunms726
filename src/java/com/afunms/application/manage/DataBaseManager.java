...
//		SysLogger.info(sql1.toString());
    ...
    public MonitorDBDTO getMonitorDBDTOByDBVo(DBVo vo , int sid){
		...
		if ("Oracle".equalsIgnoreCase(dbtype)){
			...
			String hex = tranfer.formIpToHex(ipAddress.split(":")[0]);
...
//			}
	...
	private String add() {
		...
		if (getParaIntValue("dbtype") == oracletypevo.getId()) {
        	...
        	//SysLogger.info("##############################");
        	//SysLogger.info("### 开始采集ID为"+oracle.getId()+"的ORACLE数据 ");
        	//SysLogger.info("##############################");
...
//			}
	    	...
	    	if("sqlserver".equalsIgnoreCase(dbTypeVo.getDbtype()) ){
	        	...
	        	SysLogger.info("##############################");
	        	SysLogger.info("### 开始采集ID为"+vo.getId()+"的SQLSERVER数据 ");
	        	SysLogger.info("##############################");
	        	...
	        	SysLogger.info("##############################");
	        	SysLogger.info("### 开始采集ID为"+vo.getId()+"的Sybase数据 ");
	        	SysLogger.info("##############################");
