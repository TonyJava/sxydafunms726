...
//				try{
//					Hashtable hash1 = getCategory(ip,"SOCKETPing","ConnectUtilization",starttime1,totime1,initconf.getPort());						
...
//				}
	...
	private String showServiceEventReport() {
		...
		if (initconf != null) {
			...
			try {
				list = eventdao.getQuery(starttime, totime, "socket", status
