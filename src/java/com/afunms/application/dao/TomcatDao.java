...
//					allipstr=ip1+ip2+ip3+ip4;
					...
					CreateTableManager ctable = new CreateTableManager();
	       			...
	       			ctable.deleteTable(conn,"tomcatpinghour",allipstr,"tomcatpinghour");//Ping
	       			ctable.deleteTable(conn,"tomcatpingday",allipstr,"tomcatpingday");//Ping    
...
//					allipstr=ip1+ip2+ip3+ip4;
		    		...
		    		ctable.createTable(conn,"tomcatpinghour",allipstr,"tomcatpinghour");//Ping
		    		ctable.createTable(conn,"tomcatpingday",allipstr,"tomcatpingday");//Ping
		    		conn.executeBatch();
	           }
   ...
   public boolean save(BaseVo baseVo)
   {
	   ...
	   Tomcat vo = (Tomcat)baseVo;	   
	   StringBuffer sql = new StringBuffer();
	   sql.append("insert into app_tomcat_node(id,alias,ip_address,ip_long,port,user,password,sendemail,sendmobiles,sendphone,bid,monflag,version,jvmversion,jvmvender,os,osversion)values(");
	   sql.append(vo.getId());
	   sql.append(",'");
	   sql.append(vo.getAlias());
	   sql.append("','");
