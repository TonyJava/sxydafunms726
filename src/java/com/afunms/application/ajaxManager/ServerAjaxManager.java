...
//			 sb.append("</graph></graphs></chart>");
	...
	private void ajaxHostInfolist() {
		try {
			...
			System.out.println("首页====typeString===="+typeString);
...
//							}
							 ...
							 cpuValueColor=this.computeColor(AgentalarmControlutil.GetAlarmlevel(monitorNodeDTO.getId()+"", typeString, "cpu", ""));
...
//							}
							memoryValueColor=this.computeColor(AgentalarmControlutil.GetAlarmlevel(monitorNodeDTO.getId()+"", typeString, "physicalmemory", ""));
