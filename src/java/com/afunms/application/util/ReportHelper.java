				...
				try {
					if (typevo.getDbtype().equalsIgnoreCase("oracle")) {
						...
						pinghash = hostmanager.getCategory(ip + ":" + sid,
								...
								toTime);
						curhash = hostmanager.getCurByCategory(ip + ":" + sid,
						...
						curhash = hostmanager.getCurByCategory(ip, "SQLPing",
								"ConnectUtilization");
						...
						pinghash = hostmanager.getCategory(ip, "SYSPing",
								"ConnectUtilization", startTime, toTime);
						curhash = hostmanager.getCurByCategory(ip, "SYSPing",
						"ConnectUtilization");
					} else if (typevo.getDbtype().equalsIgnoreCase("informix")) {
						pinghash = hostmanager.getCategory(ip, "INFORMIXPing",
								"ConnectUtilization", startTime, toTime);
						curhash = hostmanager.getCurByCategory(ip, "INFORMIXPing",
						"ConnectUtilization");
					} else if (typevo.getDbtype().equalsIgnoreCase("mysql")) {// HONGLI
						pinghash = hostmanager.getCategory(ip, "MYPing",
								"ConnectUtilization", startTime, toTime);
						curhash = hostmanager.getCurByCategory(ip, "MYPing",
						"ConnectUtilization");
					}
					if (pinghash != null && pinghash.size() > 0) {
						List pingDataList = (List) pinghash.get("list");
